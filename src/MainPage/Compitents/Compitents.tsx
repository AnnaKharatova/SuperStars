...
import { LineChart, CartesianGrid, Tooltip, XAxis, ResponsiveContainer, YAxis, Legend, Line } from 'recharts';
    ...
    <div className='compitents'>
      ...
      <ResponsiveContainer>
        <LineChart width={730} height={350} data={data}
          ...
          <Legend onClick={handleLegentClick} payload={[
            { value: 'Анализ данных и применение методов машинного обучения', color: '#8884d8' },
          ...
          {hardSkills ?
            <>
              <Line name='Анализ данных и применение методов машинного обучения' type="monotone" dataKey="pv" stroke="#8884d8" onClick={handleLineClick}></Line>
