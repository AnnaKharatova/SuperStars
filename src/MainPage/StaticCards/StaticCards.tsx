    ...
    <ul className='static-cards'>
      <li className='static-card'>
        <div className='static-card__data'>
          ...
          <div className='static-card__progress'>
            <img className='static-card__progress-arrow' src={progressArrowUp} alt='progress arrow' />
            <div className='static-card__progress-data'>30 %</div>
          </div>
        </div>
      ...
      <li className='static-card'>
        <div className='static-card__data'>
          ...
          <div className='static-card__progress'>
            <img className='static-card__progress-arrow' src={progressArrowDown} alt='progress arrow' />
            <div className='static-card__progress-data'>12 %</div>
          </div>
        </div>
      ...
      <li className='static-card static-card__progress-bar' >
        ...
        <div>
          ...
          <div className="progress-bar">
            <div className="progress-bar__fill" id="progressBarFill" style={{ width: "70%" }}></div>
          </div>
