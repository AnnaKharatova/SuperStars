...
function MainPage() {
  ...
  const skillsColors = ['#E10D34', '#008E74', '#24E7E5', '#B342E8', '#08AEAE', '#221670'];

  return (
    <main className='main'>
      <section className='main__title-group' >
        <h2 className='main__title'>Аналитика данных</h2>
        <span className='main__title-span'>18 сотрудников</span>
      </section>
      <section className='analyst'>
        <StaticCards />
        <DonutChart data={gradesData} colors={gradesColors} title='Распределение по грейдам' />
        <DonutChart data={skillsData} colors={skillsColors} title='Распределение по владению навыками' />
      </section>
      <section className='analyst'>
        <Compitents />
        <RaitingDinamics />
